...
## 🔀 Fluxo de trabalho
- Para cada assunto novo, abrir uma Pull Request separada

## 🎮 Estudo de funcionalidades
- Explorar funcionalidades de jogos e entender **como** funcionam por baixo dos panos

## 🛠️ Prática
- Criar um exemplo prático para cada funcionalidade estudada
